...
function FormControls({ formType, setFormType }: any) {
  return (
...
function FormType({ name, formType, onClick }: any) {
  return (
    <BaseButton
      height={[12, 16]}
      fontSize={['3xl', '4xl']}
...
function LoginOrRegisterForm({ formType, ...rest }: any) {
  ...
  const validateOnChange = (e: any) => triggerValidation(e.target.name)
